...
Examples: 435
====
URL: https://www.openml.org/search?type=data&id=56
====
Description: **Author**:   
**Source**: Unknown -   
**Please cite**:   
...
====
Target Variable: Class (nominal, 2 distinct): ['democrat', 'republican']
====
Features:

handicapped-infants (nominal, 2 distinct): ['n', 'y']
water-project-cost-sharing (nominal, 2 distinct): ['y', 'n']
adoption-of-the-budget-resolution (nominal, 2 distinct): ['y', 'n']
physician-fee-freeze (nominal, 2 distinct): ['n', 'y']
el-salvador-aid (nominal, 2 distinct): ['y', 'n']
religious-groups-in-schools (nominal, 2 distinct): ['y', 'n']
anti-satellite-test-ban (nominal, 2 distinct): ['y', 'n']
aid-to-nicaraguan-contras (nominal, 2 distinct): ['y', 'n']
mx-missile (nominal, 2 distinct): ['y', 'n']
immigration (nominal, 2 distinct): ['y', 'n']
synfuels-corporation-cutback (nominal, 2 distinct): ['n', 'y']
education-spending (nominal, 2 distinct): ['n', 'y']
superfund-right-to-sue (nominal, 2 distinct): ['y', 'n']
crime (nominal, 2 distinct): ['y', 'n']
duty-free-exports (nominal, 2 distinct): ['n', 'y']
export-administration-act-south-africa (nominal, 2 distinct): ['y', 'n']
'''

CONTEXT = "1984 United States Congressional Voting Records"
