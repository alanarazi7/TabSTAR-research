...
1. Title: Nursery Database
 ...
 CLASSINDEX: last
====
Target Variable: class (nominal, 5 distinct): ['not_recom', 'priority', 'spec_prior', 'very_recom', 'recommend']
====
Features:

parents (nominal, 3 distinct): ['usual', 'pretentious', 'great_pret']
has_nurs (nominal, 5 distinct): ['proper', 'less_proper', 'improper', 'critical', 'very_crit']
form (nominal, 4 distinct): ['complete', 'completed', 'incomplete', 'foster']
children (nominal, 4 distinct): ['1', '2', '3', 'more']
housing (nominal, 3 distinct): ['convenient', 'less_conv', 'critical']
finance (nominal, 2 distinct): ['convenient', 'inconv']
social (nominal, 3 distinct): ['nonprob', 'slightly_prob', 'problematic']
health (nominal, 3 distinct): ['recommended', 'priority', 'not_recom']
'''

CONTEXT = "Nursery School Applications in Slovenia"
TARGET = CuratedTarget(raw_name="class", new_name="Admission Decision", task_type=SupervisedTask.MULTICLASS)
COLS_TO_DROP = []
FEATURES = []